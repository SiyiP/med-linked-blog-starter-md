...
collection of whole blood - what comes out of the vein - mainly centrifuged, getting rbcs on bottom, plasma on top, and separate the two. 
...
- aphaeresis - uses centrifugation into components. - will centrifuge into components 
...
==things we can do to make blood safer:== 
...
- ==Rh antigen - if you have it you're Rh poz and if you don't it's neg.== 
ABO
...
==weak subgroups - there's multiple variants of A; there's A1 (strong, 80% of the population), and A2==
...
==bombay phenotype== 
- ==recall - first step of blood is to add fucose... to terminal galactose of precursor... **this requires functional H gene... but if this is non functional, you have bombay's phenotype.**==
	- ==bombay's is h/h instead of H/H , no H substance is made.== 
...
Rh - rhesus - protein is a big thing, along it it projects to the external surface of the red cell 
...
- ==coombs reagent = solution of IgG antibodies, tiny little jobs. directed to FC of igG. can be clinically significant but can't agglutinate; allows crosslink from igG molecule on one RBC to IgG on another RBC==
- IgG too small to agglutinate bc they are NOT IgM 
- allows crosslinking from an IgG molecule on one RBC to IgG on another RBC and makes an agglutinate -
...
- to determine if here's a igG antibody or complement attached to rbc surface. ==if the direct antiglobulin test is poz:== 
...
- rbcs - commonly transfused, to restore or maintain **oxygen carrying capacity - nothing else!**
	...
	- guidelines - if 10+ hb, don't transfuse unless symptoms indicated. ==<6 hemoglobin = transfusion indicated.== 
	- ==active bleeding - might need transfusion - but the hb doesn't mean much, rely on clinical symptoms==, estimated blood loss and symptoms. not too good at testing how much would help 
- when to transfusion - surgery - need for this is set up by surgeons in different hospitals
- reducing need for rbc transfusion 
	- ==reducing rbc transfusion need: anemia should be corrected pre surg== 
...
- when to transfuse in trauma - ==trauma resuscitation - stop the lethal triad: hemodilution, acidosis, hypothermia== , mainly based on their symptoms - major complications is the coagulopathy f trauma can be exacerbated 
...
- ==sickle cell dz - SCD - point mutation on b globulin chain, distorting rbc, vaso occlusive; to relieve symptoms, inc o2 carrying, decrease blood viscosity== 
	...
	- ==complication with chronic transfusions - iron overload with tooo much== 

platelet transfusions
- either derived from whole blood products (50 mL and 4-6 products are pooled together) 
- or collected by ==apheresis (300 mL platelets and each is a full adult dose)==
...
- refractory pts to platelets
	- ==refractory patients to platelets basically might not get any boosts at all.== causes:
		- spleen issues, sepsis, fever, meds
		- ==immune: HLA or platelet specific antibodies==
			- this is alloimmunization due to blood exposure...  
...
- ==plasma is used for active bleeding due to **multiple coagulation factor deficiencies like liver dz**==
...
==cryoprecipitate - made from plasma frozen within 8 hrs of collection== - they are cold-insoluble proteins
...
==granulocyte transfusions - only for severely granulocytic pts who are septic+with no improvement== and are currently treated with no improvement with antibiotics 
...
- but for ==stem cells - ABO compatibility is not a barrier!!!== requires in unique issues;
	- blood product compatibility - specific compatibility guides for each blood type 
...
2 categories
- ==ABO HDFN - most of these cases== 
	- ==most common mom group O (a ton of IgG anti A and B) and baby group A/B, where typeA/B have small amount of IgG antiA/b== and type A/B have very small amount of IgG antiA/anti-B
...
- ==immune antibody HDFN Rh or other antibody== 
	...
	- at first prenatal visit - we do ABO/Rh antibody screen.... if Rh-neg mom and screen neg - go to prevention (she has no antibody - we need to make sure she doesnt develop any)
		...
		- ==after delivery, figure out if baby is Rh poz or neg. if Rh poz neonate, assess fetal maternal hemorrhage, and give RhIg basically== - how much of the bleed did the mom get ? ): 
			...
			- at delivery check approx volume of fetal maternal hemorrhage in case:
				- ==rosette test of maternal hemorrhage - **big or small? if small, one dose is ok, but if large, more needed**==
	...
	- if ==rh poz mom, screen poz or rh neg and screen poz, we would eval -> they already got an antibody==. what antibody is positive? some antibodies can cause HDFN and some don't 
		- ==if IgG v IgM... then do a maternal titer if IgG antibody. higher titer, esp past 8 = more severe HDFN. more likely to cause fetal risk.== 
...
![[4b. Transfusion Medicine III-Transfusion Complications_Squires_NOTES.pdf]]
 ...
 ==Non‐Infectious Transfusion Complications== • Classified by predominant symptom 
 ...
 ==Anaphylactic txf. rx. •==
- ==more srs with all the allergy symptoms plus severe hypotension/shock==
- basically result from IgE hypersensitivity 1 
- main thing that ==might cause this is **deficiency in IgA** - basically eventually if you give more and more IgA, they might make IgA antibodies...== 
	...
	- ==treat - stop transfusion and **do not restart** , supportive oxygenation, stabilize hypotension - **crystalloids, epinephrine, dopamine if unresponsive**==

Hemolytic - typically happen when antigen poz rbcs transfused into pt with allo-antibody 
